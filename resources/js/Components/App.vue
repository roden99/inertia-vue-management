  ...
  <v-app>
      ...
      <v-navigation-drawer v-model="drawer" app class="bg-black" theme="dark">
          ...
          <v-list>
              ...
              <v-list-item :class="{
                  'hover-list-item': true,
                  'selected-list-item': isCurrentRoute('/opdlogs'),
              }" prepend-icon="mdi-file-document" link @click="$inertia.visit('/opdlogs')">
                  <v-list-item-title>OPD Logs</v-list-item-title>
              </v-list-item>
              <v-list-item :class="{
                  'hover-list-item': true,
                  'selected-list-item': isCurrentRoute('/unscanned'),
              }" prepend-icon="mdi-scanner-off" link @click="$inertia.visit('/unscanned')">
                  <v-list-item-title>Unscanned</v-list-item-title>
              </v-list-item>
              <v-list-item :class="{
                  'hover-list-item': true,
